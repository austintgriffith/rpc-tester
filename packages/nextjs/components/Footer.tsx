    ...
    <div className="min-h-0 py-5 px-1 mb-11 lg:mb-0">
      <div>
        <div className="fixed flex justify-between items-center w-full z-10 p-4 bottom-0 left-0 pointer-events-none">
          <button onClick={fetchPrice} className="flex flex-col md:flex-row gap-2 pointer-events-auto">
            {!nativeCurrencyPrice ? (
              <div className="btn btn-primary btn-sm font-normal gap-1 cursor-auto">Click to fetch price</div>
            ) : (
